...
return view.extend({
    ...
    render: function() {
        ...
        o.default =
            ...
            _('Package and Driver Verification.') +
            '</div>';
        ...
        o.render = function() {
            ...
            function loadLog() {
                ...
                fs.read('/tmp/diskmanager.log').then(function(content) {
